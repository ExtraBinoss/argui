...
import { Questionnaire, type QuestionnaireAnswer, type QuestionnaireStep } from '../../../../packages/widgets/src/solid/questionnaire'

const steps: readonly QuestionnaireStep[] = [
  {
...
export function QuestionnairePage(props: { theme: Palette }): JSX.Element {
  ...
  return <column width="fill" gap={12}>
    ...
    <Questionnaire id="foundation-k-feedback" label="Product feedback" theme={props.theme} steps={steps}
      onSubmit={(answers: Readonly<Record<string, QuestionnaireAnswer>>) => {
