...
import { Pagination, PaginationContent, PaginationEllipsis, PaginationItem, PaginationLink, PaginationNext, PaginationPrevious } from '../../../../packages/widgets/src/solid/pagination'
...
export function PaginationPage(props: { theme: Palette }): JSX.Element {
