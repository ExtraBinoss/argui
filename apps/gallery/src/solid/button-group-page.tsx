...
import { Button, ButtonGroup, ButtonGroupSeparator, ButtonGroupText, type Palette } from '@argui/widgets/solid'

/** Demonstrates horizontal, vertical, and labelled groups of native buttons. */
export function ButtonGroupPage(props: { theme: Palette }): JSX.Element {
