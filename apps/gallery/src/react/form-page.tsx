...
import { ReactForm as Form, ReactFormControl as FormControl, ReactFormDescription as FormDescription,
  ReactFormField as FormField, ReactFormInput as FormInput, ReactFormItem as FormItem,
  ReactFormLabel as FormLabel, ReactFormMessage as FormMessage, ReactFormSubmit as FormSubmit,
} from '../../../../packages/widgets/src/react/form'

/** Demonstrates uncontrolled form state, required and custom validation, and valid submission feedback. */
export function FormPage(props: { theme: Palette }): ReactElement {
