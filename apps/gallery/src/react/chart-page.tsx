...
import { ReactChart as Chart } from '../../../../packages/widgets/src/react/chart'
...
export function ChartPage(props: { theme: Palette }): ReactElement {
  const [selected, setSelected] = useState<string | null>('thu')
