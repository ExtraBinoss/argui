...
import { ReactInputGroup as InputGroup, ReactInputGroupAddon as InputGroupAddon, ReactInputGroupButton as InputGroupButton, ReactInputGroupInput as InputGroupInput, ReactInputGroupText as InputGroupText, ReactInputGroupTextarea as InputGroupTextarea } from '../../../../packages/widgets/src/react/input-group'

/** Shows controlled input-group editing, adornments, an action, and a multiline editor. */
export function InputGroupPage(props: { theme: Palette }): ReactElement {
  const [query, setQuery] = useState('issue:open')
  const [message, setMessage] = useState('Summarize the latest release notes.')
