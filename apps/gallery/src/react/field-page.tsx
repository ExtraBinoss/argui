...
import { ReactField as Field, ReactFieldDescription as FieldDescription, ReactFieldError as FieldError, ReactFieldGroup as FieldGroup, ReactFieldLabel as FieldLabel, ReactFieldLegend as FieldLegend, ReactFieldSet as FieldSet } from '../../../../packages/widgets/src/react/field'
import { ReactInputGroup as InputGroup, ReactInputGroupAddon as InputGroupAddon, ReactInputGroupInput as InputGroupInput, ReactInputGroupText as InputGroupText } from '../../../../packages/widgets/src/react/input-group'

/** Demonstrates field composition, semantic label relations, and live validation. */
export function FieldPage(props: { theme: Palette }): ReactElement {
