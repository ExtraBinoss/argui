...
//! This crate passes Android's activity handle to Winit and runs the regular
...
use {
    ...
    argui_runtime::{AppModel, RuntimeError, RuntimeEvent},
...
pub fn run_application_with_text_engine(
    ...
    argui_runtime::run_android_application_with_text_engine(
        android_app,
        config,
        renderer,
        text_engine,
