...
pub struct UiTree {
    ...
    virtual_requests: std::collections::HashMap<NodeId, (std::ops::Range<usize>, f32)>,
    virtual_viewport_extents: std::collections::HashMap<NodeId, f32>,
...
impl UiTree {
    ...
    pub fn new(root: Element) -> Self {
        ...
        let mut tree = Self {
            ...
            virtual_requests: std::collections::HashMap::new(),
            virtual_viewport_extents: std::collections::HashMap::new(),
