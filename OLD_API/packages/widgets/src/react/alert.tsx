...
export function ReactAlert(props: AlertProps): ReactElement {
  ...
  return <rectangle width="fill" background={props.theme.surface}
    ...
    <row width="fill" padding={props.theme.overlayPadding} gap={12} align_items="start"
      ...
      {props.children ?? <column width="fill" gap={4}>
        {props.title ? <ReactAlertTitle theme={props.theme} text={props.title} variant={variant} /> : null}
        {props.description ? <ReactAlertDescription theme={props.theme} text={props.description} variant={variant} /> : null}
      </column>}
    </row>
  </rectangle>
}
...
export function ReactAlertTitle(props: AlertTitleProps): ReactElement {
...
export function ReactAlertDescription(props: AlertDescriptionProps): ReactElement {
