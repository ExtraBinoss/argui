...
export function ReactNativeSelect(props: ReactNativeSelectProps): ReactElement {
  return <ReactSelect id={props.id} label={props.label} options={props.options} value={props.value}
