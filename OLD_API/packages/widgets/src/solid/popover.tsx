...
import { VirtualList } from '@argui/solid'
...
export function Popover(props: PopoverProps): JSX.Element {
  ...
  const content = () => expanded() ? <popupWindow key={`${props.id}-popup`} anchor={props.id} placement={props.placement ?? 'bottom_start'} width={props.width ?? 260}
