...
/** Renders a themed checkbox with checked, unchecked, and indeterminate states. */
export function Checkbox(props: CheckboxProps): JSX.Element {
  const [uncontrolled, setUncontrolled] = createSignal<CheckboxValue>(props.defaultChecked ?? false)
  ...
  return <focusScope key={props.id} role="check_box" accessible_name={props.label}
