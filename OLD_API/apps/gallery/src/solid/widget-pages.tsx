...
/** Renders one Solid component demonstration selected from shared navigation. */
export function WidgetPage(props: { name: WidgetPageName; theme: Palette }): JSX.Element {
  switch (props.name) {
