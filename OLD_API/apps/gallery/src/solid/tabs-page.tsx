...
import { Tabs, TabsContent, TabsList, TabsTrigger } from '../../../../packages/widgets/src/solid/tabs'
...
export function TabsPage(props: { theme: Palette }): JSX.Element {
  const [accountTab, setAccountTab] = createSignal('profile')
