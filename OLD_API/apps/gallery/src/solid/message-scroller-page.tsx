...
import { MessageScroller } from '../../../../packages/widgets/src/solid/message-scroller'
import { Message, MessageAvatar, MessageContent, MessageHeader } from '../../../../packages/widgets/src/solid/message'
...
export function MessageScrollerPage(props: { theme: Palette }): JSX.Element {
  const [offset, setOffset] = createSignal<MessageScrollOffset>({ x: 0, y: 0 })
  return <column width="fill" gap={12}>
    ...
    <MessageScroller id="chat-scroller-demo" theme={props.theme} label="Scrollable team conversation"
      ...
      {messages.map(([sender, body], index) => <Message
