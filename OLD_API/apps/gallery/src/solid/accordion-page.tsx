...
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '../../../../packages/widgets/src/solid/accordion'
...
export function AccordionPage(props: { theme: Palette }): JSX.Element {
  const [value, setValue] = createSignal('product')
