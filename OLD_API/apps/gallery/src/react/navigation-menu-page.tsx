...
import { NavigationMenu } from '../../../../packages/widgets/src/react/navigation-menu'
...
export function NavigationMenuPage(props: { theme: Palette }): ReactElement {
  const [openMenu, setOpenMenu] = useState<string | undefined>()
  const [selected, setSelected] = useState('home')
  const [lastVisited, setLastVisited] = useState('/home')
