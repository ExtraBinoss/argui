...
import { DropdownMenu } from '../../../../packages/widgets/src/react/dropdown-menu'
...
export function DropdownMenuPage(props: { theme: Palette }): ReactElement {
  const [lastAction, setLastAction] = useState('Nothing selected')
  const [radioChoice, setRadioChoice] = useState('personal')
