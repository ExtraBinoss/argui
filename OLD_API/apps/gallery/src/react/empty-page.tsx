...
import { Button, Empty, EmptyContent, EmptyDescription, EmptyHeader, EmptyMedia, EmptyTitle, type Palette } from '@argui/widgets/react'

/** Shows a composable empty state and a control that fills it with content. */
export function EmptyPage(props: { theme: Palette }): ReactElement {
