...
For the consolidation work identified by the 2026-09-22 audit, use the
[general UI plan](GENERAL_UI_PLAN.md) and its
[execution checklist](GENERAL_UI_CHECKLIST.md). They distinguish existing
