...
| Plateformes | [Application, fenêtres et tray](platform/application.md) · [WebView](platform/webview.md) · [Sélection de fichiers](platform/file-picker.md) · [Fonds de bureau](platform/desktop-backdrops.md) · [Popovers natifs](platform/native-popovers.md) |
