...
`tests/pages/timeline.mjs` verifies Web execution and accessible actions. Its
software-browser screenshot remained white, so it is not evidence of visual
correctness. The final coverage gate has not been run for this addition.
