...
The complete [incremental measurement data](incremental-optimizations-data.json)
...
[private Linux display](linux_testing.md). Their screenshots verify rendering
