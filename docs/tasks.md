...
**Examples → Draft Studio** combines cancellation with a VList, in-memory draft
editing, undo/redo and shared actions. See [actions and editing](actions-editing.md).
