...
déjà observées dans [widget-gallery-performance.md](../performance/footprint.md#widget-gallery-release-footprint).
...
[desktop-backdrops.md](../platform/desktop-backdrops.md).
...
Conserver les règles de [code_quality.md](code-quality.md) : tests ciblés pendant
