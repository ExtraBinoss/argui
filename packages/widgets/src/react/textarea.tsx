...
export function ReactTextarea(props: ReactTextareaProps): ReactElement {
  ...
  return <column width="fill" gap={6}>
    {props.showLabel ? <ReactLabel id={labelId} htmlFor={props.id} text={label} theme={props.theme}
    ...
    <rectangle width="fill" height={height}
      ...
      <textInput nativeKey={props.id} role="text_area" width="fill" height="fill" clip={true} multiline={true}
